<template>
  <div class="navv">
    ...
    <div class="content" v-for="todo in todos" :key="todo.id">
      <Todo :name="todo.name" :game="todo.rating" :imgUrl="todo.banner_img" :id="todo.id" :progress=false @changedProgress="toggleOngoing" @remmed="removeTodo" @updatedContent="changeContent"/>
    </div>
